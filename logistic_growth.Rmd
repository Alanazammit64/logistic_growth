...
file.rename("exponential_graph.png", "figures/exponential_graph.png")
file.rename("expvslog.png", "figures/expvslog.png")
file.rename("expvsloglog.png", "figures/expvsloglog.png")
file.rename("Logistic_graph.png", "figures/logistic_graph.png")
file.rename("model_and_data.png", "figures/model_and_data.png")
file.rename("model_and_data1.png", "figures/model_and_data1.png")
file.rename("model1.png", "figures/model1.png")
file.rename("model2.png", "figures/model2.png")
...
The data had to be loaded into the project, along with the necessary packages
...
# Calling in the functions from the three models completed in separate r scripts 
source("fit_linear_model.R")
...
![Graph 1: Logistic growth](figures/logistic_graph.png){width=700px}
...
ggplot(aes(t,N), data = growth_data) +
  ...
  theme_bw()
```
![Graph 2: Exponential growth](figures/exponential_graph.png){width=700px}
...
![Model 1](figures/model1.png){width=500px}
...
![Model 2](figures/model2.png){width=500px}
...
ggplot(aes(t,N), data = growth_data) +
  ...
  geom_point()
```
![Graph of modelled and actual population growth](figures/model_and_data1.png){width=700px}
...
![Altered graph of modelled and actual population growth](figures/model_and_data.png){width=700px}
...
![Graph of exponential vs logistic population growth](figures/expvslog.png){width=700px}
![Graph of exponential vs logistic population growth when log transformed](figures/expvsloglog.png){width=700px}
